...
def main_page():
    ...
    print("--- %s seconds fig_pizza_offensive---" % (time.time() - start_time))
    ...
    print("--- %s seconds fig_pizza_defensive---" % (time.time() - start_time))
    _, values_home, values_away = dfo.evaluate_home_away_rank_values_from_parameters(
        df=df_team_previous,
    ...
    print("--- %s seconds fig_pizza_passing---" % (time.time() - start_time))
    _, values_home, values_away = dfo.evaluate_home_away_rank_values_from_parameters(
        df=df_team_previous,
    ...
    print("--- %s seconds fig_pizza_physical---" % (time.time() - start_time))
    ...
    print("--- %s seconds fig_pitch_offensive---" % (time.time() - start_time))
